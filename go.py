import fresh_tomatoes	# Provided module for displaying movie information in clear and concise manner.
import media	# Contains Movie class definition.

# Create an object for every one of your favorite movie"
...
avatar = media.Movie("Avatar",
	"\"Avatar\" is the story of an ex-Marine who finds himself thrust into hostilities on an \
	alien planet filled with exotic life forms. As an Avatar, a human mind in an alien body, \
	he finds himself torn between two worlds, in a desperate fight for his own survival and \
