...
inception = media.Movie("Inception",
	"2010",
    "Visionary filmmaker Christopher Nolan (Memento, The \
    	Dark Knight) writes and directs this \
    	psychological sci-fi action film about a thief \
    	who possesses the power to enter into the dreams \
    	of others.",
...
avatar = media.Movie("Avatar", 
	"2009",
		...
		indigenous people.",
	"http://resizing.flixster.com/OPDpDBP1P_qiiOjKOW9042R4R3g=/180x270\
		/dkpu1ddg7pbsk.cloudfront.net/movie/11/17/67/11176792_ori.jpg",
	"https://www.youtube.com/watch?v=5PSNL1qE6VY")

road_to_perdition = media.Movie("Road to Perdition", 
	"2002",
	"Bonds of loyalty are put to the test when a hitman's son witnesses what \
...
good_fellas = media.Movie("Good Fellas", 
	...
	"Martin Scorsese explores the life of organized crime with his gritty, \
		kinetic adaptation of Nicolas Pileggi's best-selling Wiseguy, the true-life \
		account of mobster and FBI informant Henry Hill. Set to a true-to-period rock soundtrack, \
		the story details the rise and fall of Hill, a half-Irish, half-Sicilian New York kid \
		who grows up idolizing the \"wise guys\" in his impoverished Brooklyn neighborhood....", 
...
gangs_of_ny = media.Movie("Gangs of New York", 
	"2002",
	"In 1863, Amsterdam Vallon returns to the Five Points area of New York City seeking \
...
movies = [inception, avatar, road_to_perdition, good_fellas, gangs_of_ny, the_departed]
